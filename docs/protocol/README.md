...
| [`timesync.md`](timesync.md) | The NTP-style clock-offset algorithm folded into the heartbeat beacon, the sliding-window RTT filter, and the receive-side timestamp rewrite. |
