...
`visio.wire.v1.StreamKind` per visio-schema/docs/stream_type_map.md.
...
Dual-payload service streams (STREAM_TIMESYNC, STREAM_SCHEMA_QUERY) are
...
from visio.wire.v1 import header_pb2 as _hdr
...
_PAYLOAD_MODULES = (
    ...
    "foxglove.CompressedImage_pb2",
    "foxglove.RawImage_pb2",
    "foxglove.CameraCalibration_pb2",
    "foxglove.RawAudio_pb2",
...
def _load_payload_modules() -> None:
    for mod in _PAYLOAD_MODULES:
        try:
            ...
            # Not all payload modules are needed by every consumer; skip
            # any that this install hasn't generated rather than failing
            # the whole import.
            pass
...
class StreamMapping:
    ...
    proto_type: str             # protobuf full name (e.g. "visio.sensor.v1.ImuRaw")
...
class SchemaRegistry:
    ...
    def __init__(self) -> None:
        ...
        for v in _hdr.StreamKind.DESCRIPTOR.values:
            ...
            if not proto_type:
                # STREAM_UNKNOWN, STREAM_TIMESYNC, STREAM_SCHEMA_QUERY,
